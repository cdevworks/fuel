...
import "./RUPEEDelegate.sol";

contract RUPEEDelegator is RUPEETokenInterface, RUPEEDelegatorInterface {
    /**
     * @notice Construct a new RUPEE
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "RUPEEDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"RUPEEDelegator:fallback: cannot send value to fallback");
